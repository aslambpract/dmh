...
class TicketsController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $method    = trans('ticket_details.tickets');
           ...
           // $ticket=Ticket::select('ticket_departments.name','ticket_priorities.priority','tickets.subject','tickets.description','tickets.ticket_number','ticket_statuses.name')
           //        ->join('ticket_departments','ticket_departments.id','=','tickets.department')
...
// dd($request->all());
        return view('app.admin.helpdesk.tickets.tickets.index', compact('title', 'sub_title', 'base', 'method', 'ticket_priorities', 'ticket_departments', 'ticket_categories', 'ticket_statuses', 'ticket_types','ticket'));
    }
            ...
            if ($request->ticketnum <> 'null') {
                ...
                if ($user_id == null) {
                     ...
                     // ->where('tickets.ticket_number', 0)
                         ->select('tickets.id', 'ticket_number', 'users.name', 'subject', 'status', 'priority', 'department', 'category');

                         // ***
                   // $tickets=Ticket::select('tickets.id', 'tickets.ticket_number', 'users.name', 'tickets.subject', 'tickets.status', 'tickets.priority', 'tickets.department', 'tickets.category')
