...
class Payout extends Model
{
    ...
    protected $fillable = ['user_id', 'account_id','account_type','amount','status','payment_mode','tx_hash','2005-12-1','2005-12-1'];
    ...
    public static function createPayout($user_id,$amount)
    {
       $user_balance = DB::table('user_balance')->where('user_id', $user_id)->decrement('balance',$amount);
       $payout=DB::table('payout_request')->insert([
                    'user_id'=>$user_id,
                    'amount'=>$amount,
                    'payment_mode'=>'payout',
                    'status'=>'pending',
