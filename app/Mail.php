...
class Mail extends Model
{
    ...
    {
        $allMessages =  Mail::select('profile_infos.profile', 'users.username', 'mail_table.*')
    ...
    {
        $unread_messages = DB::table('mail_table')->join('users', 'users.id', '=', 'mail_table.from_id')->whereNull('mail_table.deleted_at')->where('mail_table.read', 'no')->where('mail_table.to_id', [$user_id])->select('mail_table.*', 'users.username')->get();
