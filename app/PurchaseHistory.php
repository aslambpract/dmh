...
class PurchaseHistory extends Model
{
    ...
    protected $fillable = ['user_id','package_id','count','total_amount','pv','pay_by','purchase_user_id','sales_status','rs_balance','purchase_type','created_at','next_purchase_date','product','approved'] ;
