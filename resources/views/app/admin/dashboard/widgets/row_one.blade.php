...
<div class="col-sm-3">
    ...
    <div class="card-header border-0 header-elements-inline pb-0">
        <h6 class="card-title">{{trans('dashboard.total_accounts')}}</h6>
    </div>
...
<div class="col-sm-3">
	<div class="card metric bg-sty1  text-dark">
	    <div class="card-header border-0 header-elements-inline pb-0">
	        <h6 class="card-title">{{trans('System BTC Wallet')}}</h6>
	    </div>
	    <div class="card-body pt-0 pb-0  text-dark">
	        <div class="d-flex mt-2">
	            <h3 class="text-4xl no-margin  font-weight-semibold mt-1 mb-0">{{ $system_btc }} </h3>  
	        </div>       
	    </div>
	</div>
</div>
