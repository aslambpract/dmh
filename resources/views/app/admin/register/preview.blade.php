...
<div class="alert bg-success alert-styled-left">
    ...
    <span class="text-semibold">{{trans('register.registration_completed')}}!</span> {{trans('register.you_have_successfully_registered')}} <strong>{{$userresult->username}} ({{$userresult->name}} {{$userresult->lastname}})</strong> in <strong>{{($userresult->tree_table->leg==='L'? 'Left' : 'Right' )}} {{trans('register.leg')}}</strong> {{trans('register.under_sponsor')}}, <strong>{{$sponsorUserName}}</strong>. {{trans('register.payment_done_via')}}<strong>
