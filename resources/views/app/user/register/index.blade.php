...
<div class="header-elements">
    ...
    <div class="card-body">
        <form class="form-vertical steps-validation" action="{{url('user/register')}}" method="POST" data-parsley-validate="true" name="form-wizard" id="regform">
            {!! csrf_field() !!}
                    ...
                    <div class="col-md-4">
                        <div class="passy required form-group-feedback-right {{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group label-indicator-absolute">
                                ...
                                <span class="label password-indicator-label-abs" style="margin-top: -12px"></span>
