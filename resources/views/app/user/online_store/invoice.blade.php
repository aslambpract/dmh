              ...
              <div class="col-sm-6">
                <div class="mb-4">
                  ...
                  <ul class="list list-unstyled mb-0">
                    ...
                    <li><a href="#">{{ option('app.company_email') }}</a></li>
                  </ul>
                </div>
              </div>
                  ...
                  <tbody>
                     @foreach($products as $key=>$items)
                      <tr>
                        ...
                        <td class="total">{{(($items->sv *$items->count))}}</td>
                      </tr>
                           @endforeach
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td class="text-right">(NPR) {{($total_amount)}}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th>{{trans('products.total')}}:</th>
                        <td class="text-right text-primary"><h5 class="font-weight-semibold">(NPR) {{($total_amount)}}</h5></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
