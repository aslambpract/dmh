...
return [
    ...
    'gt'                    => [
        'array'     => 'فإن :attribute يجب أن يكون أكثر من :value البنود.',
        'file'      => 'فإن :attribute يجب أن تكون أكبر من :value كيلو بايت.',
        'numeric'   => 'فإن :attribute يجب أن تكون أكبر من :value.',
        'string'    => 'فإن :attribute يجب أن تكون أكبر من :value حرفا.',
    ],
    'gte'                   => [
        'array'     => 'فإن :attribute أن يكون :value البنود أو أكثر.',
        'file'      => 'فإن :attribute يجب أن تكون أكبر من أو تساوي :value كيلو بايت.',
        'numeric'   => 'فإن :attribute يجب أن تكون أكبر من أو تساوي :value.',
        'string'    => 'فإن :attribute يجب أن تكون أكبر من أو تساوي :value حرفا.',
    ],
    ...
    'lt'                    => [
        'array'     => 'فإن :attribute يجب أن يكون أقل من :value البنود.',
        'file'      => 'فإن :attribute يجب أن يكون أقل من :value كيلو بايت.',
        'numeric'   => 'فإن :attribute يجب أن يكون أقل من :value.',
        'string'    => 'فإن :attribute يجب أن يكون أقل من :value حرفا.',
    ],
    'lte'                   => [
        'array'     => 'فإن :attribute يجب أن لا يكون أكثر من :value البنود.',
        'file'      => 'فإن :attribute يجب أن يكون أقل من أو يساوي :value كيلو بايت.',
        'numeric'   => 'فإن :attribute يجب أن يكون أقل من أو يساوي :value.',
        'string'    => 'فإن :attribute يجب أن يكون أقل من أو يساوي :value حرفا.',
    ],
    'max'                   => [
    ...
    'not_regex'             => 'فإن :attribute تنسيق غير صالح.',
